...
const BirthdayPartyPlannerPune = () => (
  <ServicePageLayout
    ...
    services={[
      "Balloon arches & bouquets",
      "Theme decoration & installations",
      "Backdrop & stage setup",
      "Surprise party planning",
      "Kids birthday parties",
      "Adult milestone birthdays",
    ]}
    ctaText="Plan My Birthday Party"
    ctaLink="https://wa.me/919356355950?text=Hi!%20I%20need%20a%20birthday%20party%20quote."
  />
);

export default BirthdayPartyPlannerPune;
